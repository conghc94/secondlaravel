			...
			<div class="container">
				<div class="row" style="padding-top: 10px">
					<div class="col-md-3 col-xs-4">
						<a href='http://www.khoaluan.vn/' title="Trang chủ">
			...
			<div class="container-fluid no-padding">
				<div class="navbar-collapse menuGradient">
					<ul style="display: inline-block; float: none !important;" class="nav navbar-nav">
						<li>
							<a style="min-width: 50px;" href='http://www.khoaluan.vn'>
						...
						@foreach($categories as $category)
							<li>
								...
								<li class="b-header-3__user-name">
									<a class="b-header-3__main-menu-a" href="http://www.khoaluan.vn/danh-muc_thu-vien-tai-lieu-giao-trinh-luan-van">{{$category->name}}</a>
                         		</li>
							</li>
						@endforeach
					</ul>
