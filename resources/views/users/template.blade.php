			...
			<div class="row">
				...
				<div class="container" style="padding-top: 10px;">
					...
					<div class="row">
						...
						<div class="col-md-3 col-xs-4 col-thin">

							<div class="panel panel-primary">
								<div class="panel-heading">
									<h3 class="panel-title">Thành viên</h3>
								</div>
								<div class="panel-body">
									<div style="padding: 3px;">
										<img src="https://graph.facebook.com/767528513406553/picture" id="Menu1_imgAvatar" style="width: 62px;" class="img-circle" alt="Khoaluan.vn - Thư viện tài liệu số trực tuyến" />
										<span id="Menu1_lblUserName" style="font-weight: bold; color: #787877; font-size: 17px; padding-left: 5px">Phong Phan</span>
									</div>
									<div style="padding-top: 10px;">
										<div class="content">
											<ul id="nav-sidebox" class="category-items sideboxForMenu">
												<li class="level0 subcatemenu"><a href = 'http://www.khoaluan.vn/quan-ly-tai-khoan.htm'"><span class="iconMenu glyphicon glyphicon-user"></span>Thông tin cá nhân</a>
													<li class="level0 subcatemenu"><a href = 'http://www.khoaluan.vn/tai-len'">
														<span class="iconMenu glyphicon glyphicon-cloud-upload"></span>Tải lên</a>
														<li class="level0 subcatemenu"><a href = 'http://www.khoaluan.vn/danh-sach-tai-lieu-da-tai-len'"><span class="iconMenu glyphicon glyphicon-file"></span>Tài liệu tải lên</a>
															<li class="level0 subcatemenu"><a href = 'http://www.khoaluan.vn/danh-sach-tai-lieu-da-tai'"><span class="iconMenu glyphicon glyphicon-cloud-download"></span>Danh sách đã tải</a>
																<li class="level0 subcatemenu"><a href = 'http://www.khoaluan.vn/danh-sach-tai-lieu-yeu-thich'"><span class="iconMenu glyphicon glyphicon-heart"></span>Danh sách đánh dấu</a>
																</li>
															</ul>
														</div>
													</div>
											...
											<div class="list-group">
												...
												<script>
													(function (d, s, id) {
														...
														js.src = "//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.5&appId=858822677497592";
														fjs.parentNode.insertBefore(js, fjs);
													}(document, 'script', 'facebook-jssdk'));
												</script>
												<div class="fb-page" data-href="https://www.facebook.com/laptrinhcsharpvietnam/" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
													<div class="fb-xfbml-parse-ignore">
														<blockquote cite="https://www.facebook.com/laptrinhcsharpvietnam/"><a href="https://www.facebook.com/laptrinhcsharpvietnam/">Lập trình C#</a></blockquote>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-9 col-xs-8 col-thin">
											<!-- content -->
											@yield('content')
											<!-- content -->
										</div>
									...
									<div class="container" style="color: #b1deff !important; padding-top: 15px;">
										...
										<div class="container footer-bar" style="margin: 0 auto;">
											...
											<span style="float: right; color: #afdcfd; min-width: 240px; font-size: 12px;">
												Tổng số lượt truy cập: 55,645,132
												<br />
